...
public class JiaolianLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiaolianLiuyanEntity() {

	}

	public JiaolianLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "jiaolian_liuyan_text")

    private String jiaolianLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getJiaolianLiuyanText() {
        return jiaolianLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setJiaolianLiuyanText(String jiaolianLiuyanText) {
        this.jiaolianLiuyanText = jiaolianLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "JiaolianLiuyan{" +
            ", id=" + id +
            ", jiaolianId=" + jiaolianId +
            ", yonghuId=" + yonghuId +
            ", jiaolianLiuyanText=" + jiaolianLiuyanText +
