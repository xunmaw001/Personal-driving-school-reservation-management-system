...
public class CheliangYuyueView extends CheliangYuyueEntity implements Serializable {
	...
	*/
	...
	private String cheliangYuyueYesnoValue;
	...
	* 获取： 预约状态的值
	*/
	public String getCheliangYuyueYesnoValue() {
		return cheliangYuyueYesnoValue;
	}
	/**
	* 设置： 预约状态的值
	*/
	public void setCheliangYuyueYesnoValue(String cheliangYuyueYesnoValue) {
		this.cheliangYuyueYesnoValue = cheliangYuyueYesnoValue;
	}
	...
	public String toString() {
		return "CheliangYuyueView{" +
			", cheliangYuyueYesnoValue=" + cheliangYuyueYesnoValue +
