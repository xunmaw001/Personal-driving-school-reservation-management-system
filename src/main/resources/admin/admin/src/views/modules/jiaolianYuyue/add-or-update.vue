    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教练编号" prop="jiaolianUuidNumber">
                        <el-input v-model="jiaolianForm.jiaolianUuidNumber"
                                  placeholder="教练编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教练编号" prop="jiaolianUuidNumber">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="jiaolianForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="jiaolianForm.caiNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教练类型" prop="jiaolianValue">
                        <el-input v-model="jiaolianForm.jiaolianValue"
                                  placeholder="教练类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教练类型" prop="jiaolianValue">
                            <el-input v-model="ruleForm.jiaolianValue"
                                      placeholder="教练类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教练热度" prop="jiaolianClicknum">
                        <el-input v-model="jiaolianForm.jiaolianClicknum"
                                  placeholder="教练热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教练热度" prop="jiaolianClicknum">
                            <el-input v-model="ruleForm.jiaolianClicknum"
                                      placeholder="教练热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约编号" prop="jiaolianYuyueUuidNumber">
                       <el-input v-model="ruleForm.jiaolianYuyueUuidNumber"
                                 placeholder="预约编号" clearable  :readonly="ro.jiaolianYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约编号" prop="jiaolianYuyueUuidNumber">
                           <el-input v-model="ruleForm.jiaolianYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="jiaolianYuyueText">
                        <el-input type="textarea"  :readonly="ro.jiaolianYuyueText" v-model="ruleForm.jiaolianYuyueText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianYuyueText" label="备注" prop="jiaolianYuyueText">
                            <span v-html="ruleForm.jiaolianYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jiaolianYuyueTime"  class="input" label="预约时间" prop="jiaolianYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jiaolianYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.jiaolianYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianYuyueTime" label="预约时间" prop="jiaolianYuyueTime">
                            <span v-html="ruleForm.jiaolianYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaolianYuyueYesnoTypes" label="预约状态" prop="jiaolianYuyueYesnoTypes">
                        <el-input v-model="ruleForm.jiaolianYuyueYesnoValue" placeholder="预约状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaolianYuyueYesnoText" label="审核回复" prop="jiaolianYuyueYesnoText">
                        <span v-html="ruleForm.jiaolianYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    jiaolianYuyueUuidNumber: new Date().getTime(),
                    jiaolianId: '',
                    yonghuId: '',
                    jiaolianYuyueText: '',
                    jiaolianYuyueTime: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaolian_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiaolianYuyueYesnoTypesOptions = data.data.list;
                    }
                });
