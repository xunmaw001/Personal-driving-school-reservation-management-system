    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='cheliang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车辆牌号" prop="cheliangName">
                        <el-input v-model="cheliangForm.cheliangName"
                                  placeholder="车辆牌号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="车辆牌号" prop="cheliangName">
                            <el-input v-model="ruleForm.cheliangName"
                                      placeholder="车辆牌号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='cheliang' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='cheliang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车辆热度" prop="cheliangClicknum">
                        <el-input v-model="cheliangForm.cheliangClicknum"
                                  placeholder="车辆热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="车辆热度" prop="cheliangClicknum">
                            <el-input v-model="ruleForm.cheliangClicknum"
                                      placeholder="车辆热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约编号" prop="cheliangYuyueUuidNumber">
                       <el-input v-model="ruleForm.cheliangYuyueUuidNumber"
                                 placeholder="预约编号" clearable  :readonly="ro.cheliangYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约编号" prop="cheliangYuyueUuidNumber">
                           <el-input v-model="ruleForm.cheliangYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="cheliangYuyueText">
                        <el-input type="textarea"  :readonly="ro.cheliangYuyueText" v-model="ruleForm.cheliangYuyueText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangYuyueText" label="备注" prop="cheliangYuyueText">
                            <span v-html="ruleForm.cheliangYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.cheliangYuyueTime"  class="input" label="预约时间" prop="cheliangYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.cheliangYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.cheliangYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangYuyueTime" label="预约时间" prop="cheliangYuyueTime">
                            <span v-html="ruleForm.cheliangYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.cheliangYuyueYesnoTypes" label="预约状态" prop="cheliangYuyueYesnoTypes">
                        <el-input v-model="ruleForm.cheliangYuyueYesnoValue" placeholder="预约状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.cheliangYuyueYesnoText" label="审核回复" prop="cheliangYuyueYesnoText">
                        <span v-html="ruleForm.cheliangYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    cheliangYuyueUuidNumber: false,
                    cheliangId: false,
                    yonghuId: false,
                    cheliangYuyueText: false,
                    cheliangYuyueTime: false,
                    cheliangYuyueYesnoTypes: false,
                    cheliangYuyueYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    cheliangYuyueUuidNumber: new Date().getTime(),
                    cheliangId: '',
                    yonghuId: '',
                    cheliangYuyueText: '',
                    cheliangYuyueTime: '',
                    cheliangYuyueYesnoTypes: '',
                    cheliangYuyueYesnoText: '',
                    insertTime: '',
                },
                cheliangYuyueYesnoTypesOptions : [],
                cheliangOptions : [],
                yonghuOptions : [],
                rules: {
                   cheliangYuyueUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=cheliang_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.cheliangYuyueYesnoTypesOptions = data.data.list;
                    }
                });
