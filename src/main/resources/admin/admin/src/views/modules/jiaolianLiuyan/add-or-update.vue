    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="jiaolianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.jiaolianLiuyanText" v-model="ruleForm.jiaolianLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianLiuyanText" label="留言内容" prop="jiaolianLiuyanText">
                            <span v-html="ruleForm.jiaolianLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.jiaolianId = true;//教练
                this.ro.yonghuId = true;//用户
                this.ro.jiaolianLiuyanText = true;//留言内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiaolianLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiaolianLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
