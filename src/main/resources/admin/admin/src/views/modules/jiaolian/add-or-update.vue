        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练编号" prop="jiaolianUuidNumber">
                       <el-input v-model="ruleForm.jiaolianUuidNumber"
                                 placeholder="教练编号" clearable  :readonly="ro.jiaolianUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="教练类型" prop="jiaolianTypes">
                        <el-select v-model="ruleForm.jiaolianTypes" :disabled="ro.jiaolianTypes" placeholder="请选择教练类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jiaolianContent"  label="教练介绍" prop="jiaolianContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianContent" label="教练介绍" prop="jiaolianContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaolianClicknum: [
                              { required: true, message: '教练热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   jiaolianContent: [
                              { required: true, message: '教练介绍不能为空', trigger: 'blur' },
                          ],
                   jiaolianDelete: [
