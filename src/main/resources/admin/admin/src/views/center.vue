<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='教练编号' prop="jiaolianUuidNumber">
               <el-input v-model="ruleForm.jiaolianUuidNumber"  placeholder='教练编号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='赞' prop="zanNumber">
               <el-input v-model="ruleForm.zanNumber"  placeholder='赞' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='踩' prop="caiNumber">
               <el-input v-model="ruleForm.caiNumber"  placeholder='踩' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='教练热度' prop="jiaolianClicknum">
               <el-input v-model="ruleForm.jiaolianClicknum"  placeholder='教练热度' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='jiaolian'"  label="教练介绍" prop="jiaolianContent">
                 <editor
...
// 注册表 教练 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zanNumber)&& 'jiaolian'==this.flag){
                             this.$message.error('赞不能为空');
                             return
                         }

                         if((!this.ruleForm.caiNumber)&& 'jiaolian'==this.flag){
                         ...
                         if((!this.ruleForm.jiaolianClicknum)&& 'jiaolian'==this.flag){
                             this.$message.error('教练热度不能为空');
                             return
                         }

                         if((!this.ruleForm.jiaolianContent)&& 'jiaolian'==this.flag){
                             this.$message.error('教练介绍不能为空');
                             return
                         }
