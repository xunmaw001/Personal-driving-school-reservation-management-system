...
var centerMenu = [
    ...
    ,{
        name: '车辆留言',
        url: '../cheliangLiuyan/list.html'
    }
    ,{
        name: '车辆预约',
        url: '../cheliangYuyue/list.html'
    }
    ,{
        name: '教练收藏',
        url: '../jiaolianCollection/list.html'
    }
    ,{
        name: '教练留言',
        url: '../jiaolianLiuyan/list.html'
    }
    ,{
        name: '教练预约',
        url: '../jiaolianYuyue/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/gerenjiaxiaoyuyueguanli/admin/dist/index.html#/login";
